...
export declare const defaultImageConfig: VercelImageConfig;
...
export declare function getImageConfig(images: boolean | undefined, imagesConfig: VercelImageConfig | undefined, command: string): {
    image: {
        service: {
            entrypoint: string;
